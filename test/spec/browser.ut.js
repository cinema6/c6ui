    ...
    var userAgent = {
        macOS : {
            'PHANTOM' : {
                ...
                tests : {
                    browser : { 
                        videoCanvas  : function(o) { expect(o.videoOnCanvasAllowed()).toBeTruthy() }, 
                        multiPlayers : function(o) { expect(o.multiPlayersAllowed()).toBeTruthy() }, 
                        inlineVideo  : function(o) { expect(o.inlineVideoAllowed()).toBeTruthy() }
                    },
                    app     : { 
            ...
            'SAFARI6' : {
                ...
                tests : {
                    browser : { 
                        videoCanvas  : function(o) { expect(o.videoOnCanvasAllowed()).not.toBeTruthy() }, 
                        multiPlayers : function(o) { expect(o.multiPlayersAllowed()).toBeTruthy() }, 
                        inlineVideo  : function(o) { expect(o.inlineVideoAllowed()).toBeTruthy() }, 
                    },
                    app     : { 
        ...
        ios : {
            'IPHONE_SAFARI_OS6'  : {
                ...
                tests : {
                    browser : { 
                        videoCanvas  : function(o) { expect(o.videoOnCanvasAllowed()).not.toBeTruthy() }, 
                        multiPlayers : function(o) { expect(o.multiPlayersAllowed()).not.toBeTruthy() }, 
                        inlineVideo  : function(o) { expect(o.inlineVideoAllowed()).not.toBeTruthy() }, 
                    },
                    app     : { 
                        name  : function(o) { expect(o.app.name).toEqual('safari') }, 
                ...
                describe('c6BrowserInfo',function(){
                    ...
                    describe('with userAgent ' + $os + '.' + $browser,function(){
                        beforeEach(function(){
                            ...
                            inject(['c6BrowserInfo',function(_c6BrowserInfo) {
                                c6BrowserInfo = _c6BrowserInfo;
                            }]);
                        });

                        describe('app',function(){
                            it('name',function(){
                                userAgent[$os][$browser].tests.app.name(c6BrowserInfo);
                            });
                            it('version',function(){
                                userAgent[$os][$browser].tests.app.version(c6BrowserInfo);
                            });
                        });
                        
                        describe('device',function(){
                            it('name',function(){
                                userAgent[$os][$browser].tests.device.name(c6BrowserInfo);
                            });

                            it('version',function(){
                                userAgent[$os][$browser].tests.device.version(c6BrowserInfo);
                            });

                            it('isKindle',function(){
                            	userAgent[$os][$browser].tests.device.isKindle(c6BrowserInfo);
                            });
                            
                            it('isAndroid',function(){
                            	userAgent[$os][$browser].tests.device.isAndroid(c6BrowserInfo);
                            });
                            
                            it('isIPhone',function(){
                            	userAgent[$os][$browser].tests.device.isIPhone(c6BrowserInfo);
                            });
                            
                            it('isIPod',function(){
                            	userAgent[$os][$browser].tests.device.isIPod(c6BrowserInfo);
                            });
                            
                            it('isIPad',function(){
                            	userAgent[$os][$browser].tests.device.isIPad(c6BrowserInfo);
                            });
                            
                            it('isIOS',function(){
                            	userAgent[$os][$browser].tests.device.isIOS(c6BrowserInfo);
                            });
                            
                            it('isMobile',function(){
                            	userAgent[$os][$browser].tests.device.isMobile(c6BrowserInfo);
                            });
                        ...
                        describe('os',function(){
                            it('name',function(){
                                userAgent[$os][$browser].tests.os.name(c6BrowserInfo);
                            });
                            it('version',function(){
                                userAgent[$os][$browser].tests.os.version(c6BrowserInfo);
                            });
                        });
                        
                        describe('browser',function(){
                            it('inlineVideo',function(){
                                userAgent[$os][$browser].tests.browser.inlineVideo(c6BrowserInfo);
                            });
                            it('multiPlayers',function(){
                                userAgent[$os][$browser].tests.browser.multiPlayers(c6BrowserInfo);
                            });
                            it('videoCanvas',function(){
                                userAgent[$os][$browser].tests.browser.videoCanvas(c6BrowserInfo);
                            });
                        });
                    });
                }); 
